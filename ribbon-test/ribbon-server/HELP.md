...
* The following dependencies are not known to work with Spring Native: 'Cloud LoadBalancer, Spring Boot DevTools'. As a
...
```
$ docker run --rm ribbon-server:0.0.1-SNAPSHOT
```
...
```
$ build/native-image/ribbon-server
```
